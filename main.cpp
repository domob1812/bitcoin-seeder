...
extern "C" void* ThreadSeeder(void*) {
  db.Add(CService("46.101.15.140", GetDefaultPort(fTestNet)), true);
  db.Add(CService("139.59.173.255", GetDefaultPort(fTestNet)), true);
  db.Add(CService("178.62.99.51", GetDefaultPort(fTestNet)), true);
  do {
